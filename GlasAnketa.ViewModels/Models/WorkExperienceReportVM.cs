...
{
    public class WorkExperienceReportVM
    {
        public string ExperienceRange { get; set; }
        public int? CompanyId { get; set; }

        // Number of distinct users (CompanyId) in this work experience bucket
        ...
        // Comma-separated list of distinct CompanyIds contributing to this experience bucket
